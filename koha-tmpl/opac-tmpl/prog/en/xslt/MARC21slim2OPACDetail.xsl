  ...
  exclude-result-prefixes="marc items">
   ...
   <xsl:if test="$DisplayOPACiconsXSLT!='0'">
       ...
       <xsl:if test="marc:datafield[@tag=020]">
        ...
        <!-- SPL:Formatted Contents Note -->
        <xsl:if test="marc:datafield[@tag=505]">
            <span class="results_summary"><span class="label">Formatted Contents Note: </span>
        ...
        <!-- SPL:Creation/Production Credits Note -->
        <xsl:if test="marc:datafield[@tag=508]">
            <span class="results_summary"><span class="label">Creation/Production Credits Note: </span>
        ...
        <!-- SPL:Original Version Note  -->
        <xsl:if test="marc:datafield[@tag=534]">
            <span class="results_summary"><span class="label">Original Version Note: </span>
        ...
        <xsl:if test="marc:datafield[@tag=546]">
            <span class="results_summary"><span class="label">Language Note: </span>
        ...
        <xsl:if test="marc:datafield[@tag=590]">
            <span class="results_summary"><span class="label">Local Notes: </span>
